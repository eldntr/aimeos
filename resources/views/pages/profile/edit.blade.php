    ...
    <div class="flex flex-col lg:flex-row gap-8">
        ...
        <div class="flex-1">
            ...
            <div data-tab-panel="summary" class="space-y-8">
                ...
                <section class="space-y-4">
                    <h2 class="text-lg md:text-xl font-bold text-on-surface">Aktivitas Saya</h2>
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        @if ($isMerchant)
                            <a href="{{ route('merchant.dashboard', $routeParams) }}" class="bg-surface-container-low p-6 rounded-2xl flex items-center gap-4 hover:shadow-[0_12px_36px_rgba(47,47,46,0.06)] transition-all">
                                <span class="material-symbols-outlined text-on-surface-variant">storefront</span>
                                <div>
                                    <p class="font-bold text-on-surface">Dashboard Toko</p>
                                    <p class="text-xs text-on-surface-variant">Kelola produk & pesanan</p>
                                </div>
                            </a>
                            <a href="#" class="bg-surface-container-low p-6 rounded-2xl flex items-center gap-4 hover:shadow-[0_12px_36px_rgba(47,47,46,0.06)] transition-all">
                                <span class="material-symbols-outlined text-on-surface-variant">inventory_2</span>
                                <div>
                                    <p class="font-bold text-on-surface">Produk</p>
                                    <p class="text-xs text-on-surface-variant">Tambah & atur produk</p>
                                </div>
                            </a>
                            <a href="#" class="bg-surface-container-low p-6 rounded-2xl flex items-center gap-4 hover:shadow-[0_12px_36px_rgba(47,47,46,0.06)] transition-all">
                                <span class="material-symbols-outlined text-on-surface-variant">local_shipping</span>
                                <div>
                                    <p class="font-bold text-on-surface">Pengiriman</p>
                                    <p class="text-xs text-on-surface-variant">Pantau status kirim</p>
                                </div>
                            </a>
                        @elseif ($isAdmin)
                            <a href="{{ route('admin.dashboard', $routeParams) }}" class="bg-surface-container-low p-6 rounded-2xl flex items-center gap-4 hover:shadow-[0_12px_36px_rgba(47,47,46,0.06)] transition-all">
                                <span class="material-symbols-outlined text-on-surface-variant">dashboard</span>
                                <div>
                                    <p class="font-bold text-on-surface">Admin Dashboard</p>
                                    <p class="text-xs text-on-surface-variant">Ringkasan sistem</p>
                                </div>
                            </a>
                            <a href="{{ route('admin.merchants.index', $routeParams) }}" class="bg-surface-container-low p-6 rounded-2xl flex items-center gap-4 hover:shadow-[0_12px_36px_rgba(47,47,46,0.06)] transition-all">
                                <span class="material-symbols-outlined text-on-surface-variant">verified</span>
                                <div>
                                    <p class="font-bold text-on-surface">Verifikasi Merchant</p>
                                    <p class="text-xs text-on-surface-variant">Approve & review</p>
                                </div>
                            </a>
                            <a href="#" class="bg-surface-container-low p-6 rounded-2xl flex items-center gap-4 hover:shadow-[0_12px_36px_rgba(47,47,46,0.06)] transition-all">
                                <span class="material-symbols-outlined text-on-surface-variant">groups</span>
                                <div>
                                    <p class="font-bold text-on-surface">User Management</p>
                                    <p class="text-xs text-on-surface-variant">Kelola pengguna</p>
                                </div>
                            </a>
                        @else
                            <button type="button" onclick="openWishlistModal();" class="bg-surface-container-low p-6 rounded-2xl flex items-center gap-4 hover:shadow-[0_12px_36px_rgba(47,47,46,0.06)] transition-all text-left">
                                <span class="material-symbols-outlined text-on-surface-variant">favorite</span>
                                <div>
                                    <p class="font-bold text-on-surface">Favorit</p>
                                    <p class="text-xs text-on-surface-variant">Barang tersimpan</p>
                                </div>
                            </button>
                            <button type="button" onclick="openBuyAgainModal();" class="bg-surface-container-low p-6 rounded-2xl flex items-center gap-4 hover:shadow-[0_12px_36px_rgba(47,47,46,0.06)] transition-all text-left">
                                <span class="material-symbols-outlined text-on-surface-variant">replay</span>
                                <div>
                                    <p class="font-bold text-on-surface">Beli Lagi</p>
                                    <p class="text-xs text-on-surface-variant">Transaksi sebelumnya</p>
                                </div>
                            </button>
                            <button type="button" onclick="openSupportModal();" class="bg-surface-container-low p-6 rounded-2xl flex items-center gap-4 hover:shadow-[0_12px_36px_rgba(47,47,46,0.06)] transition-all text-left">
                                <span class="material-symbols-outlined text-on-surface-variant">support_agent</span>
                                <div>
                                    <p class="font-bold text-on-surface">Bantuan</p>
                                    <p class="text-xs text-on-surface-variant">Hubungi support</p>
                                </div>
                            </button>
                        @endif
                    </div>
                    @if ($isMerchant)
                        <a href="{{ route('merchant.dashboard', $routeParams) }}" class="inline-flex items-center gap-2 px-5 py-3 rounded-full bg-primary text-white font-bold shadow-lg shadow-primary/20 hover:scale-[1.02] active:scale-95 transition-all mt-2">
                            <span class="material-symbols-outlined text-lg">storefront</span>
                            Kelola Toko
                        </a>
                    @else
                        <a href="{{ route('merchant.register', $routeParams) }}" class="inline-flex items-center gap-2 px-5 py-3 rounded-full bg-primary text-white font-bold shadow-lg shadow-primary/20 hover:scale-[1.02] active:scale-95 transition-all mt-2">
                            <span class="material-symbols-outlined text-lg">storefront</span>
